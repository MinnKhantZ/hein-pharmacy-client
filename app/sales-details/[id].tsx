...
export default function SaleDetailsScreen() {
  ...
  const [editItems, setEditItems] = useState<
    (SaleItem & { inventory_item_id?: number })[]
  >([]);
  ...
  const addItemToEdit = (item: InventoryItem) => {
    const existing = editItems.find((si) => si.inventory_item_id === item.id);
        ...
        { text: t("Cancel"), style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                "Error",
                error.response?.data?.error || t("Failed to delete sale"),
              );
            }
          },
        },
  ...
  const handleUpdateSale = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        error.response?.data?.error || t("Failed to update sale"),
      );
    } finally {
      setUpdating(false);
    }
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={
            isDesktop ? styles.desktopContentContainer : undefined
          }
        >
          {!isEditing ? (
            // View Mode
            <>
              ...
              >
                <View>
                  <Text
                    style={[
                      styles.saleTitle,
                      isDesktop && styles.desktopSaleTitle,
                    ]}
                  >
                    {t("Sale")} #{sale.id}
                  </Text>
                  <Text
                    style={[
                      styles.saleDate,
                      isDesktop && styles.desktopSaleDate,
                    ]}
                  >
                ...
                <Text
                  style={[
                    styles.totalAmount,
                    isDesktop && styles.desktopTotalAmount,
                  ]}
                >
              ...
              >
                <View
                  style={[
                    styles.mainContent,
                    isDesktop && styles.desktopMainContent,
                  ]}
                >
                  <View
                  ...
                  >
                    ...
                    {sale.customer_name && (
                      <View
                        style={[
                          styles.infoRow,
                          isDesktop && styles.desktopInfoRow,
                        ]}
                      >
                        <Text
                          style={[
                            styles.infoLabel,
                            isDesktop && styles.desktopInfoLabel,
                          ]}
                        >
                          {t("Customer Name:")}
                        </Text>
                        <Text
                          style={[
                            styles.infoValue,
                            isDesktop && styles.desktopInfoValue,
                          ]}
                        >
                          {sale.customer_name}
                        </Text>
                    ...
                    {sale.notes && (
                      <View
                        style={[
                          ...
                          isDesktop && styles.desktopNotesContainer,
                        ]}
                      >
                        <Text
                          style={[
                            styles.notesLabel,
                            isDesktop && styles.desktopNotesLabel,
                          ]}
                        >
                          {t("Notes:")}
                        </Text>
                        <Text
                          style={[
                            styles.notesText,
                            isDesktop && styles.desktopNotesText,
                          ]}
                        >
                          {sale.notes}
                        </Text>
                  ...
                  >
                    ...
                    {sale.items.map((item, index) => (
                      <View
                        ...
                        style={[
                          styles.itemRow,
                          isDesktop && styles.desktopItemRow,
                        ]}
                      >
                        <View
                          style={[
                            styles.itemInfo,
                            isDesktop && styles.desktopItemInfo,
                          ]}
                        >
                          <Text
                            style={[
                              styles.itemName,
                              isDesktop && styles.desktopItemName,
                            ]}
                          >
                            {item.item_name}
                          </Text>
                          <Text
                            style={[
                              styles.itemOwner,
                              isDesktop && styles.desktopItemOwner,
                            ]}
                          >
                          ...
                          <Text
                            style={[
                              styles.itemDetails,
                              isDesktop && styles.desktopItemDetails,
                            ]}
                          >
                        ...
                        <Text
                          style={[
                            styles.itemTotal,
                            isDesktop && styles.desktopItemTotal,
                          ]}
                        >
                    ...
                    <View
                      style={[
                        styles.totalRow,
                        isDesktop && styles.desktopTotalRow,
                      ]}
                    >
                      <Text
                        style={[
                          styles.totalLabel,
                          isDesktop && styles.desktopTotalLabel,
                        ]}
                      >
                        {t("Total:")}
                      </Text>
                      <Text
                        style={[
                          styles.totalValue,
                          isDesktop && styles.desktopTotalValue,
                        ]}
                      >
                        {formatPrice(Number(sale.total_amount))}
                      </Text>
                ...
                <View
                  style={[
                    ...
                    isDesktop && styles.desktopPrintButtonContainer,
                  ]}
                >
                  <View
                  ...
                  <PrintReceipt
                    ...
                    buttonStyle={[
                      ...
                      isDesktop && styles.desktopPrintReceiptButton,
                    ]}
                    onPrintSuccess={() => {
            ...
            <>
              ...
              >
                <Text
                  style={[
                    styles.editTitle,
                    isDesktop && styles.desktopEditTitle,
                  ]}
                >
                  {t("Edit Sale")} #{sale.id}
                </Text>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      style={[
                        styles.paymentLabel,
                        isDesktop && styles.desktopPaymentLabel,
                      ]}
                    >
                      {t("Payment Method:")}
                    </Text>
                    <View
                      style={[
                        ...
                        isDesktop && styles.desktopPaymentMethodsContainer,
                      ]}
                    >
                    ...
                    <TextInput
                      style={[
                        styles.input,
                        styles.notesInput,
                        isDesktop && styles.desktopNotesInput,
                      ]}
                      placeholder={t("Notes")}
                      value={editNotes}
                  ...
                  >
                    ...
                    {editItems.map((item, index) => (
                      <View
                        ...
                        style={[
                          styles.editItemRow,
                          isDesktop && styles.desktopEditItemRow,
                        ]}
                      >
                        <View
                          style={[
                            styles.editItemInfo,
                            isDesktop && styles.desktopEditItemInfo,
                          ]}
                        >
                          <Text
                            style={[
                        ...
                        <View
                          style={[
                            styles.editItemActions,
                            isDesktop && styles.desktopEditItemActions,
                          ]}
                        >
                          <TouchableOpacity
                            style={[
                              styles.quantityButton,
                              isDesktop && styles.desktopQuantityButton,
                            ]}
                            onPress={() =>
                          ...
                          >
                            <Text
                              style={[
                                ...
                                isDesktop && styles.desktopQuantityButtonText,
                              ]}
                            >
                              −
                            </Text>
                          ...
                          <Text
                            style={[
                              styles.quantityText,
                              isDesktop && styles.desktopQuantityText,
                            ]}
                          >
                            {Math.floor(Number(item.quantity))}
                          </Text>
                          ...
                          <TouchableOpacity
                            style={[
                              styles.removeButton,
                              isDesktop && styles.desktopRemoveButton,
                            ]}
                          ...
                          >
                            <Text
                              style={[
                                ...
                                isDesktop && styles.desktopRemoveButtonText,
                              ]}
                            >
                              ✕
                            </Text>
                        ...
                        <Text
                          style={[
                            ...
                            isDesktop && styles.desktopItemTotalPrice,
                          ]}
                        >
                          {formatPrice(Number(item.total_price))}
                        </Text>
                    ...
                    <TouchableOpacity
                      style={[
                        ...
                        isDesktop && styles.desktopAddItemButton,
                      ]}
                      onPress={() =>
                    ...
                    >
                      <Text
                        style={[
                          ...
                          isDesktop && styles.desktopAddItemButtonText,
                        ]}
                      >
                        + {t("Add Item")}
                      </Text>
                        ...
                        {searching ? (
                          ...
                          <ScrollView
                            style={[
                              ...
                              isDesktop && styles.desktopInventoryList,
                            ]}
                            nestedScrollEnabled
                            keyboardShouldPersistTaps="handled"
                          >
                            {inventoryItems.map((item) => (
                              <TouchableOpacity
                                ...
                                style={[
                                  ...
                                  isDesktop && styles.desktopInventoryItem,
                                ]}
                                onPress={() => {
                                  addItemToEdit(item);
                                  setSearchQuery("");
                                ...
                                <View style={styles.inventoryItemInfo}>
                                  <Text
                                    style={[
                                      ...
                                      isDesktop &&
                                        styles.desktopInventoryItemName,
                                    ]}
                                  >
                                    {item.name}
                                  </Text>
                                  <Text
                                    style={[
                                      ...
                                      isDesktop &&
                                        styles.desktopInventoryItemDetails,
                                    ]}
                                  >
                                    {t("Stock")}:{" "}
                                    {Math.floor(Number(item.quantity))} |{" "}
                          ...
                          <Text
                            style={[
                              styles.noItemsText,
                              isDesktop && styles.desktopNoItemsText,
                            ]}
                          >
                            {t("No items found")}
                          </Text>
                    ...
                    <View
                      style={[
                        styles.editTotalRow,
                        isDesktop && styles.desktopEditTotalRow,
                      ]}
                    >
                      <Text
                        style={[
                ...
                <View
                  style={[
                    styles.editActionButtonsContainer,
                    isDesktop && styles.desktopEditActionButtonsContainer,
                  ]}
                >
                  <TouchableOpacity
                    style={[
