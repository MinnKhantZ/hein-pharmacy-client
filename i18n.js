...
const resources = {
  en: {
    translation: {
      ...
      "Expiry Date (Soonest First)": "Expiry Date (Soonest First)",
      "Expiry Date (Latest First)": "Expiry Date (Latest First)",
      ...
      "Enable Expiration Alerts": "Enable Expiration Alerts",
      "Get notified daily before items expire":
        "Get notified daily before items expire",
      "Expiration Alert Days Before": "Expiration Alert Days Before",
      "Days before expiry": "Days before expiry",
      "Expiration Alert Time": "Expiration Alert Time",
      "Daily expiration notifications will be sent at this time":
        "Daily expiration notifications will be sent at this time",
  ...
  my: {
    translation: {
      ...
      "Expiry Date (Soonest First)": "သက်တမ်းကုန်ရက် (နီးဆုံးမှစ)",
      "Expiry Date (Latest First)": "သက်တမ်းကုန်ရက် (အဝေးဆုံးမှစ)",
      "Recently Added": "လတ်တလောထည့်သည်",
      "No items found": "ပစ္စည်းများမတွေ့ရှိပါ",
      "Low Stock": "လက်ကျန်နည်းသည်",
      "Expiring Soon": "သက်တမ်းကုန်ခါနီး",
      "Qty:": "အရေအတွက်:",
      "Owner:": "ပိုင်ရှင်:",
      ...
      "Unit Price *": "တစ်ခုဈေးနှုန်း *",
      "Selling Price *": "ရောင်းဈေးနှုန်း *",
      "Expiry Date (YYYY-MM-DD)": "သက်တမ်းကုန်ရက် (YYYY-MM-DD)",
      Owner: "ပိုင်ရှင်",
      ...
      "Enable Expiration Alerts": "သက်တမ်းကုန်အသိပေးချက်များဖွင့်ပါ",
      "Get notified daily before items expire":
        "ပစ္စည်းသက်တမ်းမကုန်မီ နေ့စဉ်အသိပေးပါ",
      "Expiration Alert Days Before": "မကုန်မီအသိပေးရမည့်ရက်အရေအတွက်",
      "Days before expiry": "မကုန်မီရက်",
      "Expiration Alert Time": "သက်တမ်းကုန်အသိပေးချိန်",
      "Daily expiration notifications will be sent at this time":
        "ဤအချိန်တွင် သက်တမ်းကုန်အသိပေးချက်များကို နေ့စဉ်ပို့ပါမည်",
